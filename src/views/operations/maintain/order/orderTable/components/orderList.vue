			...
			<Table v-model="query" :columns="columns" :tableData="tableData">
				<template v-slot:fixed="{ row }">
					<el-button type="text" v-if="row.status == 1"
						>派单</el-button
					>
					<el-button type="text" v-if="row.status == 2"
						>接单</el-button
					>
					<el-button type="text" v-if="row.status == 3"
						>报障</el-button
					>
					<el-button type="text" v-if="row.status == 3"
						>结束</el-button
					>
					<el-button class="xz" type="text" v-if="row.status == 3"
						>协助</el-button
					>
					<el-button class="zd" type="text" v-if="row.status == 3"
						>转单</el-button
					>
					<el-button class="gq" type="text" v-if="row.status == 3"
						>挂起</el-button
					>
					<el-button type="text" v-if="row.status == 4"
						>恢复</el-button
					>
					<el-button type="text" v-if="row.status == 5"
						>同意</el-button
					>
					<el-button class="jj" type="text" v-if="row.status == 5"
						>拒绝</el-button
					>
					<el-button type="text" v-if="row.status == 6"
						>评价</el-button
					>
					<el-button type="text" v-if="row.status == 7"
						>详情</el-button
					>
				</template>
			</Table>
