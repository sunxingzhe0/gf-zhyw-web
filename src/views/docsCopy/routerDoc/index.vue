...
<template>
  <div class="routerDoc">
    ...
    <div class="doc-container">
      <div class="doc-aside" width="200px">
        <template v-for="(item, index) in views">
          ...
          <template v-else>
            <div :key="'title' + index">
              ...
              <div class="doc-nav-group">
                <div
                  class="doc-nav-item"
                  :class="citem.path == activeItem.path ? 'active' : ''"
                  :key="'c' + cindex"
                  @click="activeItem = citem"
          ...
          <!-- <div class="nav-item" :key="index" v-if="!item.children?.length"></div> -->
        </template>
      </div>
      <div class="doc-main">
        <el-tree
...
export default {
  ...
  mounted() {
    // console.log(routers);
    // console.log(Views);
    this.views = this.formatDeep(Views);
    console.log(JSON.parse(JSON.stringify(this.views)));
